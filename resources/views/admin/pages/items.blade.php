					...
					<div class="modal fade" id="exampleModaleditreviewe{{ $item->id }}" 
						...
						<div class="modal-dialog modal-dialog-centered" role="document">
							<div class="modal-content">
								...
								{{ Form::open(['url'=>'admin/page-items/edit/'.$item->id,'files'=>true,'enctype'=>'multipart']) }}
									<div class="form-row">
										...
										<div class="form-row">
												<label for="inputEmail4"> Sub title 2 </label>
												{{ Form::text('sub_title2',$item->sub_title2,['class'=>
												'form-control'
													]) }}
										</div>
										...
										<div class="form-group col-md-4">
											<img src="{{ URL::to($item->image2) }}" class="img-thumbnail"	>
										</div>
										<div class="form-row">
											<div class="form-group col-md-8">
					  ...
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      ...
					      <div class="modal-footer">
					        ...
					        <a href="{{ URL::to('admin/page-items/delete/'.$item->id) }}" class="btn btn-danger"> confirm</a>
					      </div>
					    </div>
					  </div>
					</div>
	...
	<div class="modal fade" id="exampleModalreviewadd" tabindex="-1" role="dialog" 
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
				{{ Form::open(['url'=>'admin/page-items/add/'.$data->id,'files'=>true,'enctype'=>'multipart']) }}
					<div class="form-row">
						<div class="form-group col-md-12">
							<label for="inputEmail4">Title</label>
					...
					<div class="form-row">
						<div class="form-group col-md-12">
							<label for="inputEmail4">Sub title 2</label>
							{{ Form::text('sub_title2',null,['class'=>'form-control'
