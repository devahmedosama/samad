        ...
        <div class="row">
            <div class="col-lg-12 col-sm-12">
                <div class="card m-b-30">
                    <div class="card-body">
                    {{ Form::open(['url'=>'admin/pages/edit/'.$data->id,'enctype'=>'multipart','files'=>true]) }}
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-2 col-form-label">Video  2</label>
                            <div class="col-sm-7">
                                <input class="form-control" type="file" name="video2"  value="" id="example-text-input">
                            </div>
                            <div class="col-sm-3">
                                <video width="150" controls>
                                    <source src="{{ URL::to($data->video2) }}" type="video/mp4">
                                    Your browser does not support the video tag.
                                </video>
                            </div>
                        </div>
